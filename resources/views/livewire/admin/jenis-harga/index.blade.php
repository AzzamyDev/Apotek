...
<section class="section">
    <div wire:ignore>
        <div class="modal fade" id="form-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <livewire:admin.jenis-harga.form>
        </div>
    </div>
    <div class="section-header row g-2">
        <div class="col">
            <h1>Daftar Jenis Harga</h1>
        </div>
        <div class="col-auto">
            <div><button type="button" class="btn btn-block btn-primary"
                    wire:click="$emitTo('admin.jenis-harga.form','open','')">Tambah
                    Jenis Harga</button>
            </div>
        </div>
    </div>
                        ...
                        <table class="table table-striped table-md">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Nama Jenis Harga</th>
                                ...
                                @foreach ($jenis as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button"
                                                wire:click="$emitTo('admin.jenis-harga.form','open','{{ $item->id }}')"
