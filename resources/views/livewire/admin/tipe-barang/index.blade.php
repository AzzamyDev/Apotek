...
<section class="section">
    <div wire:ignore>
        <div class="modal fade" id="form-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <livewire:admin.tipe-barang.form>
        </div>
    </div>
    <div class="section-header row g-2">
        <div class="col">
            <h1>DaftarTipe Barang</h1>
        </div>
        <div class="col-auto">
            <div><button type="button" class="btn btn-block btn-primary"
                    wire:click="$emitTo('admin.tipe-barang.form','open','')">Tambah
                    Tipe Barang</button>
            </div>
        </div>
    </div>
                                ...
                                @foreach ($tipe as $item)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button"
                                                wire:click="$emitTo('admin.tipe-barang.form','open','{{ $item->id }}')"
